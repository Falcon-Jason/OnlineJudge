...
type JudgeClient interface {
	Judge(ctx context.Context, in *Submission, opts ...grpc.CallOption) (*JudgeReply, error)
}
...
func (c *judgeClient) Judge(ctx context.Context, in *Submission, opts ...grpc.CallOption) (*JudgeReply, error) {
	out := new(JudgeReply)
	err := c.cc.Invoke(ctx, "/submission.Judge/Judge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type JudgeServer interface {
	Judge(context.Context, *Submission) (*JudgeReply, error)
...
func (UnimplementedJudgeServer) Judge(context.Context, *Submission) (*JudgeReply, error) {
...
func _Judge_Judge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/submission.Judge/Judge",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JudgeServer).Judge(ctx, req.(*Submission))
	}
